...
const senderKeys: KeyInfo = {
  address: 'X-fuji1huh8kja7cw9nljkx8rrqazjph4lkaucqndv3z2',
  publicKey: '7vg6Grf2UBLBsTyTU1ELSjHETDJwbjHyRbgqJtgxDzL14FzwZR',
  privateKey: 'PrivateKey-Tmnbxi3K4y61uLN9DJdbFJcB1g7Bv1bdgkmo4tJQq1s8Hyors',
};
const assetID = "2jfeSgJ1rnXy5cc8z1gU7hVzu6H77kPBudenrpzjA8zLgkcJm7"; // the transaction ID is used as asset ID
const friendsAddress = "X-fuji1ulvrp90dmmpaux0qpklrjeq49hdwmxcgfa066f"; // address format is Bech32
// ============ Main Part of Script ===================
